...
public class ActivityResource {
     ...
     */
    @PostMapping(path = "/activities", headers = "Accept=application/json")
    @Timed
    ...
    @PathParam("search") String search, Pageable pageable) {
        log.debug("ASDASDASDASDASDA ASDASDASDASDASDAASDASDASDASDASDAASDASDASDASDASDA {}", filtersForActivity.toString());
